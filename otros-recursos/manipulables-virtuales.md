...
* [Materiales del proyecto Gauss \(en procomún\)](https://procomun.educalab.es/es/ode-search?sort=publicationDate-DESC&query=ProyectoGauss&f[0]=type%3A"ODE"&type=LEARNING_RESOURCE]%28https://procomun.educalab.es/es/ode-search?sort=publicationDate-DESC&query=ProyectoGauss&f[0]=type%3A"ODE"&type=LEARNING_RESOURCE). Recientemente, todo lo realizado en el proyecto Gauss ha sido actualizado a HTML5, por lo que se pueden utilizar sin problemas.
